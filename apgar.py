def apgar():
	...
	print('\n')
	promptcomplexion = eval(input ('Enter value for Complexion (Appearance). '))
	print('\n')
	print('0 = Absent ')
	print('1 = <100 beats per minute ')
	print('2 = >100 beats per minute ')
	print('\n')
	promptpulsescore = eval(input ('Enter value for Pulse. '))
	print('\n')
	print('0 = No response to stimulation ') 
	print('1 = Grimace on suction or aggressive stimulation ')
	print('2 = Cry on stimulation ')
	print('\n')
	promptgrimace = eval(input ('Enter value for Grimace. '))
	print('\n')
	print('0 = None ')
	print('1 = Some flexion ')
	print('2 = Flexed arms and legs that resist extension ')
	print('\n')
	promptactivity = eval(input ('Enter value for Activity. '))
	print('\n')
	print('0 = Absent ')
	print('1 = Weak, irregular, gasping ')
	print('2 = Strong cry ')
	print('\n')
	promptrespiration = eval(input ('Enter value for respiration. '))
	print('\n')
	try:
