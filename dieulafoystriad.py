def dieulafoystriad():
	print("Dieulafoy's Triad is used to identify acute appendicitis.\n")
	print("The triad is comprised of: Hyperesthesia of the skin (hypersensitivity to touch), exquisite tenderness and guarding over McBurney's point.\n")
